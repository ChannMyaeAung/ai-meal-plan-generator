    ...
    <div className="px-4 py-8 sm:py-12 max-w-7xl mx-auto">
      <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
        <div className="px-4 py-10 md:py-20">
          ...
          >
            <Link href="/mealplan">
              <Button className="w-60 transform rounded-lg bg-primary dark:bg-primary px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:text-white dark:hover:bg-chart-5 cursor-pointer">
                Explore Now
              </Button>
            </Link>
