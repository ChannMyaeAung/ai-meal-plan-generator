...
const SubscribePage = () => {
  return (
    <div
      className={`${bodyFont.className} relative isolate min-h-dvh overflow-hidden bg-linear-to-br from-rose-50 via-amber-50 to-slate-50 px-6 py-12 text-slate-900 dark:from-[#030712] dark:via-[#04050a] dark:to-[#000000] dark:text-slate-100`}
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-12">
        <header className="text-center">
          ...
          <h1
            className={`${headingFont.className} mx-auto max-w-3xl text-4xl font-semibold leading-tight text-slate-900 md:text-5xl dark:text-white`}
          >
        ...
        <section className="grid gap-8 md:grid-cols-3 place-items-baseline">
                ...
                <ul className="space-y-3">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <span className="mt-0.5 flex h-6 w-6 items-center justify-center rounded-full bg-linear-to-br from-amber-400 to-rose-400 text-white">
